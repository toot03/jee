...
@WebServlet(name="NameServlet3", urlPatterns = "/Servlet3")
//@WebServlet(urlPatterns = "/Servlet3")
public class CoolServlet3 extends HttpServlet {
    ...
    throws ServletException, IOException {
	    ...
	    out.println( "<h1>LabSERVLET_01 : héritage HttpServlet + déclaration avec @WebServlet</h1>" );
